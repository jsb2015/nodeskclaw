...
| 失败原因 | 失败或拒绝时，说明 Agent 可采取行动的原因，例如未授权、已占用、租约失效、状态冲突、能力不支持、外部系统失败、风险策略拦截 |
...
### 2.4 Level 2 Control Transfer Profile
...
5. 设备动作结果能表达操作意图、结果语义、状态变化、失败原因、外部副作用、审计证据和下一步建议。
